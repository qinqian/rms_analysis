...
main() {
  ...
  #                   --csv=MAST139_1cells.csv
   ...
   #for i in 20082_hg19_premrna 29806_hg19_premrna 21202_hg19_premrna 20696_hg19; do
   for i in 20082_hg19_premrna; do
   ...
   #   #                                --label $i
   #   Rscript annotate_celltypes.R --seuratobj ../results/seurat_sara/${i}_hg19_premrna_seurat-object.rds --label  ${i}_annotation
   #done
}
