...
MAST85_1 = readRDS('../data/seurat_obj/20190815_seurat-object_MAST85-1cell.rds')
RH74_10 = readRDS('../data/seurat_obj/20190815_seurat-object_RH74-10cells.rds')
MAST139_1 = readRDS('../results/seurat_sara/MAST139_1cells_seurat-object.rds')
MSK72117_1 = readRDS('../results/seurat_sara/C12SC2_seurat-object.rds')


## all.obj = Reduce('merge', list(MAST111, MAST139, MAST39, RH74, MAST95, MAST85, MSK82489, MAST35,
##                                MSK72117_10cells, MAST118, MSK74711, MAST85_1, RH74_10, MAST139_1, MSK72117_1))

all.obj = Reduce('merge', list(MAST111, MAST139, MAST39, MAST95, MAST85, MSK82489, MAST35,
                               MSK72117_10cells, MAST118, MSK74711, MAST85_1, MAST139_1, MSK72117_1))
...
all.obj@meta.data$orig.ident2 = all.obj@meta.data$orig.ident
all.obj@meta.data$orig.ident2 [all.obj@meta.data$orig.ident2=='MAST139_1cells'] = 'MAST139-1cell'
all.obj@meta.data$orig.ident2 [all.obj@meta.data$orig.ident2=='C12SC2'] = 'MSK72117-1cell'
all.obj@meta.data$orig.ident2 [all.obj@meta.data$orig.ident2=='MSK72117tencell'] = 'MSK72117'
