...
gsf = Sys.glob('~/langenau/projects/01_sc_rms/final_annotations/gene_modules/*txt')
...
de = c('~/langenau/projects/01_sc_rms/results/seurat_sara/20190624_seurat-object_MAST111_SCT_res0.8.xls', '~/langenau/projects/01_sc_rms/results/seurat_sara/20190624_seurat-object_MAST139_SCT_res0.8.xls', '~/langenau/projects/01_sc_rms/results/seurat_sara/20190624_seurat-object_MAST35_SCT_res0.8.xls', '~/langenau/projects/01_sc_rms/results/seurat_sara/20190624_seurat-object_MAST39_SCT_res0.8.xls', '~/langenau/projects/01_sc_rms/results/seurat_sara/20190624_seurat-object_MAST85_SCT_res0.8.xls', '~/langenau/projects/01_sc_rms/results/seurat_sara/20190624_seurat-object_MAST95_SCT_res0.8.xls', '~/langenau/projects/01_sc_rms/results/seurat_sara/20190624_seurat-object_MSK82489_SCT_res0.8.xls', '~/langenau/projects/01_sc_rms/results/seurat_sara/20190624_seurat-object_RH74_SCT_res0.8.xls', '~/langenau/projects/01_sc_rms/results/seurat_sara/20191031_MSK72117tencell_sara_v4_res0.8.xls', '~/langenau/projects/01_sc_rms/results/seurat_sara/20191031_MSK74711_seurat-object_sara_v4_res0.8.xls', '~/langenau/projects/01_sc_rms/results/seurat_sara/MAST118_seurat-object_sara_v4_res0.8.xls')
...
targetm = deal[#c('GO_NEUROGENESIS',
    c(
                 ...
                 'MAST118_cluster12',
        'MAST95_cluster8')]
targetm[['MSK72117_cluster3/5']] = unique(c(deal[['MSK72117_cluster3']], deal[['MSK72117_cluster5']]))
